...
export default function LoginPage({ onSuccess, onGoRegister, onClose }) {
      ...
      <div style={styles.overlay} onClick={onClose}>
        <div style={styles.card} onClick={(e) => e.stopPropagation()}>
          ...
          <div style={styles.successWrap}>
            <SuccessIcon />
            <h2 style={styles.successTitle}>SESIÓN INICIADA</h2>
            <p style={styles.successText}>¡Bienvenido de nuevo, {successName}! Ya estás dentro.</p>
    ...
    <div style={styles.overlay} onClick={onClose}>
      <div style={styles.card} onClick={(e) => e.stopPropagation()}>
        ...
        <p style={styles.switch}>
          ¿No tienes cuenta?{' '}
          <button style={styles.link} onClick={onGoRegister}>Regístrate</button>
        </p>
      </div>
    </div>
  );
